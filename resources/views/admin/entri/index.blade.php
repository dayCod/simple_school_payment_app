...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- form -->
        <form action="{{ route('asEntri.store') }}" method="post">@csrf 
          <div class="form-group">
            Pilih Siswa :
            <select multiple  class="js-example-basic-single form-control" name="nisn" style="width: 100%;">
              @foreach($siswa as $s)
          ...
          <div class="form-group">
            <select class=" form-control" id="list" name="id_kelas">
  ...
  <div class="form-group">
    <select name="jumlah_dibayar" class="form-control">
      ...
      @foreach($spp as $s)
      <option value="{{ $s->nominal }}">Rp. {{ $s->nominal }}</option>
      @endforeach
    </select>
  </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    	<center>
	                    	<div class="btn-group">
	                    		<a href="{{ action('entriController@edit', $d['id_pembayaran']) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                          <a href="{{ action('entriController@destroy', $d['id_pembayaran']) }}" class="btn btn-sm btn-danger delete-btn"><i class="fa fa-trash"></i></a>
