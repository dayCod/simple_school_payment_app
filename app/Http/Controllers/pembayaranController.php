...
class pembayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        $spp = spp::all();
        $kelas = kelas::all();
        return view('admin.allPembayaran.index',['kelas'=>$kelas,'data'=>$data,'siswa'=>$siswa,'spp'=>$spp]);
    }
    ...
    public function edit($payment)
    {
        ...
        return view('admin.allPembayaran.edit',compact('update','payment'));
    }
    ...
    public function update(Request $request, $payment)
    {
        ...
        return redirect()->route('asPembayaran.index')->withMessage('Data berhasil di update');
    }
    ...
    public function destroy($payment)
    {
        ...
        return redirect()->back()->withMessage('Data berhasil dihapus');
    }
}
